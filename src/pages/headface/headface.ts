...
import { IonicPage, NavController, normalizeURL, ViewController, NavParams, ActionSheetController, LoadingController, ToastController,Platform } from 'ionic-angular';
...
declare var cordova:any; //导入第三方的库定义到项目中
/**
...
export class HeadfacePage extends BaseUI {
  ...
  // 将获取到的图片或者相机拍摄到的图片进行一下另存为，用于后期图片的上传使用
  ...
  uploadImage(){
    ...
    var loading = super.showToast(this.toastCtrl,'上传中....')
    // 开始正式的上传
